...
class ShopifyCustomer(TenantScopedModel):
    ...
    # Address data (stored as JSON since Shopify has multiple addresses)
...
class ShopifyOrder(TenantScopedModel):
    ...
    name = models.CharField(max_length=50, blank=True)  # e.g., "#1001"
    email = models.EmailField(blank=True)
    phone = models.CharField(max_length=50, blank=True)
    ...
    # Order items (stored as JSON for detailed Shopify data)
