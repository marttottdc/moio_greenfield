    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suggested_activities', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financial_status', models.CharField(blank=True, choices=[('pending', 'Pending'), ('authorized', 'Authorized'), ('paid', 'Paid'), ('partially_paid', 'Partially Paid'), ('refunded', 'Refunded'), ('voided', 'Voided')], max_length=20)),
                ('fulfillment_status', models.CharField(blank=True, choices=[('fulfilled', 'Fulfilled'), ('partial', 'Partial'), ('unfulfilled', 'Unfulfilled')], max_length=20)),
                ('created_at_shopify', models.DateTimeField(blank=True, null=True)),
                ('updated_at_shopify', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at_shopify', models.DateTimeField(blank=True, null=True)),
                ('last_synced', models.DateTimeField(blank=True, null=True)),
                ('sync_status', models.CharField(choices=[('active', 'Active'), ('archived', 'Archived'), ('draft', 'Draft')], default='active', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_uuid', models.UUIDField(db_index=True, editable=False, null=True)),
                ('sync_type', models.CharField(choices=[('products', 'Products'), ('customers', 'Customers'), ('orders', 'Orders')], max_length=20)),
