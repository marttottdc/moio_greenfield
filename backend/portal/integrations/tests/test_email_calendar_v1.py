...
from portal.integrations.v1.views.email import EmailAccountsView
from portal.integrations.v1.models import ExternalAccount, EmailAccount, CalendarAccount
from portal.integrations.v1.services.accounts import ensure_user_slot_available
from portal.integrations.v1 import urls as v1_urls  # ensure import doesn't blow up
